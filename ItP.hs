...
gender, number, person, gcase, pronType, tense, aspect, prepType 
		 :: Agreement -> Agreement
...
tense    = filter (`elem` [Past,Pres,Fut,Infl]) 
aspect   = filter (`elem` [Perf,Imperf])
prepType = filter (`elem` [A,Da,Di,In,Su,Con,Per]) 
...
-- If the subject of a sentence is dropped,
-- insert pro
...
preproc ("al":xs)   = "a":"il":preproc xs
preproc ("allo":xs) = "a":"lo":preproc xs
preproc ("alla":xs) = "a":"la":preproc xs
preproc ("all'":xs) = "a":"l'":preproc xs
preproc ("ai":xs)   = "a":"i":preproc xs
preproc ("agli":xs) = "a":"gli":preproc xs
preproc ("agl'":xs) = "a":"gl'":preproc xs
preproc ("alle":xs) = "a":"le":preproc xs

preproc ("dal":xs)   = "da":"il":preproc xs
preproc ("dallo":xs) = "da":"lo":preproc xs
preproc ("dalla":xs) = "da":"la":preproc xs
preproc ("dall'":xs) = "da":"l'":preproc xs
preproc ("dai":xs)   = "da":"i":preproc xs
preproc ("dagli":xs) = "da":"gli":preproc xs
preproc ("dagl'":xs) = "da":"gl'":preproc xs
preproc ("dalle":xs) = "da":"le":preproc xs

preproc ("del":xs)   = "di":"il":preproc xs
preproc ("dello":xs) = "di":"lo":preproc xs
preproc ("della":xs) = "di":"la":preproc xs
preproc ("dell'":xs) = "di":"l'":preproc xs
preproc ("dei":xs)   = "di":"i":preproc xs
preproc ("degli":xs) = "di":"gli":preproc xs
preproc ("degl'":xs) = "di":"gl'":preproc xs
preproc ("delle":xs) = "di":"le":preproc xs

preproc ("nel":xs)   = "in":"il":preproc xs
preproc ("nello":xs) = "in":"lo":preproc xs
preproc ("nella":xs) = "in":"la":preproc xs
preproc ("nell'":xs) = "in":"l'":preproc xs
preproc ("nei":xs)   = "in":"i":preproc xs
preproc ("negli":xs) = "in":"gli":preproc xs
preproc ("negl'":xs) = "in":"gl'":preproc xs
preproc ("nelle":xs) = "in":"le":preproc xs

preproc ("sul":xs)   = "su":"il":preproc xs
preproc ("sullo":xs) = "su":"lo":preproc xs
preproc ("sulla":xs) = "su":"la":preproc xs
preproc ("sull'":xs) = "su":"l'":preproc xs
preproc ("sui":xs)   = "su":"i":preproc xs
preproc ("sugli":xs) = "su":"gli":preproc xs
preproc ("sugl'":xs) = "su":"gl'":preproc xs
preproc ("sulle":xs) = "su":"le":preproc xs

preproc ("col":xs) = "con":"il":preproc xs
...
prsTestSent :: Int -> [ParseTree Cat Cat]
prsTestSent n = prs (testSents!!n)

prsTestSents :: [[ParseTree Cat Cat]]
prsTestSents = map prs testSents
